...
```bash
tar xzf class-method-darwin-arm64.tar.gz
chmod +x class-method-darwin-arm64

# macOS: Gatekeeper の警告を解除
xattr -d com.apple.quarantine class-method-darwin-arm64
